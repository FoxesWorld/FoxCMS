...
class JoinServer {
    ...
    private function validateSession() : bool {
        $this->logger->WriteLine("Validating session for userMd5: <b>" . $this->sessionData['selectedProfile'].'</b>');
    ...
    private function updateSession() : void {
        $this->logger->WriteLine("Updating session for userMd5: <b>" . $this->sessionData['selectedProfile'].'</b>');
...
/*
        if ($stmt->rowCount() === 1) {
            $this->logger->WriteLine("Session updated successfully for userMd5: <b>" . $this->sessionData['selectedProfile'].'</b>');
            //json_encode(['id' => $this->sessionData['selectedProfile'], 'name' => $this->sessionData['user']]));
        } else {
