...
if (isset($user[0])) {
    try {
        ...
        // Лучше залогировать ошибку или предпринять другие действия для обработки ошибки
        // В случае возникновения ошибки выход из скрипта может привести к нежелательным последствиям
