<tr>
    ...
    <td>
		...
		<button class="btn bg-orange-800 btn-sm btn-raised position-left legitRipple deleteServerButt" data-serverId="{index}" data-serverName="{serverName}"><i class="fa-thin fa-trash"></i></button>
	</td>
</tr>