<tr>
    ...
    <td>
		<div class="buttonGroup">
			...
			<button class="btn bg-orange-600 btn-sm btn-raised position-left legitRipple loadUserBadges" data-action="badges" data-login="{login}"><i class="fa-thin fa-badge"></i></button>
		</div>
    </td>
</tr>
