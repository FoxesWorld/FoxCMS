...
<head>
	...
	<!-- <script src="./ERBAEV.CAT_files/title.js.download"></script> -->

</head>

<body oncontextmenu="return false;" unselectable="on" onselectstart="return false;"><canvas></canvas>
...
canvas.addEventListener('touchmove', function(e) {
    ...
    count++;
    (count > 25) && (colorArr = [ Math.random() + 0.2, Math.random() + 0.2, Math.random() + 0.2 ], count = 0); //SizeOf entity
