...
(function(global, factory) {
  ...
  var defaultOptions = {
    ...
    labelIdle: [
      'Перетащите файл в это окно <span class="filepond--label-action">(Обзор)</span>',
      Type.STRING
    ],
    labelInvalidField: ['Недопустимый файл', Type.STRING],
    labelFileWaitingForSize: ['Вычисляем размер', Type.STRING],
    labelFileSizeNotAvailable: ['Невозможно вычислить размер', Type.STRING],
    labelFileCountSingular: ['Список файлов', Type.STRING],
    labelFileCountPlural: ['Файлов в списке', Type.STRING],
    labelFileLoading: ['Загрузка', Type.STRING],
    labelFileAdded: ['Дабавлен', Type.STRING], // assistive only
    labelFileLoadError: ['Ошибка загрузки', Type.STRING],
    labelFileRemoved: ['Удалён', Type.STRING], // assistive only
    labelFileRemoveError: ['Ошибка удаления', Type.STRING],
    ...
    labelFileProcessingError: ['Ошибка загрузки', Type.STRING],
    labelFileProcessingRevertError: ['Error during revert', Type.STRING],

    labelTapToCancel: ['Нажмите для отмены', Type.STRING],
    labelTapToRetry: ['Нажмте для повторной загрузки', Type.STRING],
    labelTapToUndo: ['Нажмите для возврата', Type.STRING],

    labelButtonRemoveItem: ['Удалить', Type.STRING],
    labelButtonAbortItemLoad: ['Отмена', Type.STRING],
    labelButtonRetryItemLoad: ['Повторить', Type.STRING],
    labelButtonAbortItemProcessing: ['Отмена', Type.STRING],
    labelButtonUndoItemProcessing: ['Вернуть', Type.STRING],
