...
if (HDSkin($member_id['uuid'])) $info = returnNotifer("У вас есть возможность установить себе HD скин с разрешением от 64х32 до 2048x1024", 'check', '', 'margin-top: 10px;');
...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . "/uploads/skins/$username.png")) $disabled = "disabled";
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . "/uploads/capes/$username.png")) {
