...
!function(e, t) {
    ...
    var e = function(e) {
        ...
        t("ALLOW_HOPPER_ITEM", function(e, t) {
            var n = t.query;
            return !n("GET_ALLOW_FILE_TYPE_VALIDATION") || a(e, n("GET_ACCEPTED_FILE_TYPES"))
        }),
            ...
            return new Promise(function(t, i) {
                if (n("GET_ALLOW_FILE_TYPE_VALIDATION")) {
                    var T = n("GET_ACCEPTED_FILE_TYPES")
                      ...
                      , o = a(e, T, l)
                      , r = function() {
                        var e, t = T.map((e = n("GET_FILE_VALIDATE_TYPE_LABEL_EXPECTED_TYPES_MAP"),
                        function(t) {
