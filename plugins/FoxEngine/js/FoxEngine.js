        ...
        if (page !== FoxEngine.selectPage.thisPage && FoxEngine.selectPage.thisPage !== undefined) {
            ...
            optionContent.onreadystatechange = function() {
                if (optionContent.readyState === 4) {
					...
					option = response.getElementsByTagName('useroption')[0];
					content = response.getElementsByTagName('pageContent')[0];
					if(option !== undefined) {
            ...
            if (lastUserReq.readyState === 4) {
				...
				<tr>
					...
					<div class="profile-title">
						<ul>
					   <li><h1><a href="#" onclick="viewUserProfile('` + lastUser.login + `'); return false;">` + lastUser.login + `</a></h1></li>
